...
crearBarra(netcore);
let anzure = document.getElementById("azure");
crearBarra(azure);
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalEf = setInterval(function(){
            pintarBarra(ef, 16, 4, intervalEf);
        },100);
        ...
        const intervalNetcore = setInterval(function(){
            pintarBarra(netcore, 11, 6, intervalNetcore);
        },100);
        const intervalAzure = setInterval(function(){
            pintarBarra(azure, 11, 7, intervalAzure);
        },100);
    }
}
